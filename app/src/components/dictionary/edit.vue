            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="dataDictionary.dataType" id="dataType" type="text" class="form-control"
                           name="dataType">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="dataDictionary.dataCode" id="dataCode" type="text" class="form-control"
                           name="dataCode">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="dataDictionary.dataName" id="dataName" type="text" class="form-control"
                           name="dataName">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="dataDictionary.bankCode" id="bankCode" type="text" class="form-control"
                           name="bankCode">
                    <div class="message">${errors.userCnameError}</div>
                  </div>
                </div>
