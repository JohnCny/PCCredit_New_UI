        ...
        <div class="panel-body">
          <div class="table-responsive col-md-offset-3">
            <table class="center">
              ...
              <tr>
                <td>
                  <select name="" multiple="multiple" size="10" id="xykh"
                          style="width: 80%; margin-left: 5%;height:200px;">
                ...
                <td>
                  <input type="button" class="edit info" value=">>" v-on:click="addroles('xykh','yjkh')"
                         style="width:70px;margin-left:-15px;"><br>
                  <input type="button" class="edit info" value="<<" v-on:click="addroles('yjkh','xykh')"
  ...
  export default{
    ...
    methods: {
      ...
      transfer: function () {
        ...
        that.$http.put(QK.SERVER_URL + '/api/customerTransfer', {
          customerIds: arrAjax,
          reason: that.reso,
