      ...
      <section class="panel">
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <form id="form_enterPrice_edit" @submit.prevent="handleSubmit">
        ...
        methods: {
            handleSubmit () {
                ...
                if (bool) {
                    ...
                    console.log()
                    var enterPrise = {
                      "id" : that.enterPrise.id,
                      "cname" : that.enterPrise.cname,
                      "certificateNumber" : that.enterPrise.certificateNumber,
                      "homeAddress" : that.enterPrise.homeAddress,
                      "tel" : that.enterPrise.tel,
                      "enterpriseCname" : that.enterPrise.enterpriseCname,
                      "enterpriseIdCard" : that.enterPrise.enterpriseIdCard,
                      "industry" : $("#industryEn").val().join(","),
                      "customerType" : 1,
                    }
                    that.$http.put(QK.SERVER_URL+'/api/customerBasic',enterPrise,true).then(function (data) {
            ...
            idNumberCheck:function(){
                var that = this
                var idCard = that.enterPrise.certificateNumber+''
                ...
                if (len < 14) {
                    ...
                    that.$http.get(QK.SERVER_URL+'/api/customerBasic/idCardExist?identityCard='+idCard,true).then(function (res) {
