            ...
            <div class="row">
              <div class="col-md-6">
                <div id="nameDiv" class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="userSession.username" id="username" type="text" class="form-control" name="username" readonly>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="userSession.userCname" id="userCname" type="text" class="form-control" name="userCname" placeholder="请输入中文名2到10位">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input  v-model="userSession.age" id="age" type="text" class="form-control" name="age" placeholder="请输入10-99之间的年龄值" >
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input  v-model="userSession.tel" id="tel" type="text" class="form-control" name="tel" placeholder="请正确填写您的电话号码">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="userSession.idCardNumber" id="idCardNumber" type="text" class="form-control" name="idCardNumber" readonly>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="userSession.status" id="status" type="text" class="form-control" name="status" readonly>
            ...
            <div class=row>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select  v-model="userSession.roleType" id="roleId" type="text" name="roleId" class="form-control" disabled>
                      <option value="-1">&#45;&#45;请选择&#45;&#45;</option>
                      <template v-for="role in roles">
                        <option v-bind:value="role.id" v-if="userSession.roleType==role.id" selected>${role.roleNameZh}</option>
