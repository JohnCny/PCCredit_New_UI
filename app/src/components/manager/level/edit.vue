            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.levelName" id="levelName" type="text" class="form-control" name="levelName"
                           readonly>
              ...
              <div class="col-md-6">
                <div id="nameDiv" class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.levelCredit" id="levelCredit" type="text" class="form-control"
                           name="levelCredit" placeholder="请输入对应额度">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.overdueTolerateRate" id="overdueTolerateRate" type="text" class="form-control"
                           name="overdueTolerateRate" placeholder="请输入10-99之间的年龄值">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.badloanTolerateRate" id="badloanTolerateRate" type="text" class="form-control"
                           name="badloanTolerateRate" placeholder="请输入10-99之间的年龄值">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.postloanMonitorTolerateNum" id="postloanMonitorTolerateNum" type="text"
                           class="form-control" name="postloanMonitorTolerateNum" placeholder="请正确填写您的电话号码">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.loanLimitMin" id="loanLimitMin" type="text" class="form-control"
                           name="loanLimitMin" placeholder="请输入正确的身份证号">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.loanNumberMin" id="loanNumberMin" type="text" class="form-control"
                           name="loanNumberMin" placeholder="请输入合法的邮件地址">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.overdueRateMin" id="overdueRateMin" type="text" class="form-control"
                           name="overdueRateMin" placeholder="请输入合法的邮件地址">
            ...
            <div class=row>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.badloanRateMin" id="badloanRateMin" type="text" class="form-control"
                           name="badloanRateMin" placeholder="请输入合法的邮件地址">
    ...
    methods: {
      handleSubmit () {
        ...
        var bool = QK.formValidation({
          id: "#managerLevelEdit",
          rulesMap: {
            badloanRateMin: {required: !0},
            badloanTolerateRate: {required: !0},
            id: {required: !0},
            levelCredit: {required: !0},
            levelName: {required: !0},
            loanLimitMin: {required: !0},
            loanNumberMin: {required: !0},
            overdueRateMin: {required: !0},
            overdueTolerateRate: {required: !0},
            postloanMonitorTolerateNum: {required: !0},
          }
        })
        //验证结果  true  false
        if (bool) {
