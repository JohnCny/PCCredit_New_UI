            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select v-bind:disabled="disabled" id="userIds" v-model="userIds"
                          class="form-control select2-multiple" name="userIds" multiple>
    ...
    methods: {
      ...
      handleSubmit () {
        ...
        if (bool) {
          ...
          that.$http.post(QK.SERVER_URL + '/api/userTeam', {
            teamId: that.team.teamId,
