              ...
              <div class="col-md-3 col-md-offset-4 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="collectionType" type="text" name="collectionType" v-model="infos.collectionType"
                            class="form-control">
            ...
            <div class="row">
              <div class="col-md-3 col-md-offset-4 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="collectionResult" type="text" name="collectionResult" v-model="infos.collectionResult"
                            class="form-control">
                      <option value="-1" selected="selected">--请选择--</option>
