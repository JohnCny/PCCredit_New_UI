              ...
              <div class="col-md-3 col-md-offset-4 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="tPostLoanMonitorType" type="text" name="tPostLoanMonitorType"
                            v-model="infos.tPostLoanMonitorType" class="form-control">
            ...
            <div class="row">
              <div class="col-md-3 col-md-offset-4 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="taskStatus" type="text" name="taskStatus" v-model="infos.taskStatus"
                            class="form-control">
                      <option value="-1" selected="selected">--请选择--</option>
                      <option value="0">0</option>
                      <option value="1">1</option>
