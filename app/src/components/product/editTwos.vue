          ...
          <form  id="managerLevelNew" @submit.prevent="handleSubmit">
            <div class="row">
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input id="nodeTyp" type="text" name="nodeTyp" class="form-control" v-if="infos.nodeType == 0" v-model="node.start"  disabled>
                    <input id="nodeTyp" type="text" name="nodeTyp" class="form-control" v-if="infos.nodeType == 1" v-model="node.mid"  disabled>
                    <input id="nodeTyp" type="text" name="nodeTyp" class="form-control" v-if="infos.nodeType == 2" v-model="node.end"  disabled>
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                ...
                <div class="input-icon right">
                  <input  v-model="infos.nodeName" id="nodeNam" type="text" class="form-control" name="nodeNam" placeholder="请输入对应额度">
            ...
            <div class="row">
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="preNodeI" type="text" name="preNodeI" v-model="infos.preNodeId" class="form-control" v-on:focus="whatCheck()">
            ...
            <div class="row">
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="approveRoles" type="text" name="approveRoles"  class="form-control select2-multiple" multiple v-model="approveRoleses">
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input id="isRandomDivisio" type="radio" name="isRandomDivisio" value="1" v-model="infos.isRandomDivision">
                    <label class=" radio_a">是</label>
                    <input id="isRandomDivisi" type="radio" name="isRandomDivisio" value="0" v-model="infos.isRandomDivision">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <select id="loanMeetingTyp" type="text" name="loanMeetingTyp" v-model="infos.loanMeetingType" class="form-control">
                      <option value="-1" selected = "selected">--请选择--</option>
            ...
            <div class=row>
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    <input v-model="infos.loanLimit" id="loanLimi" type="text" class="form-control" name="loanLimi" placeholder="">
              ...
              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="input-icon right">
                    ...
                    <label class=" radio_a">是</label>
                    <input id="isLisReviewNodeoanLimi" type="radio" name="isReviewNo" value="0" v-model="infos.isReviewNode">
                    <label class=" radio_a">否</label>
