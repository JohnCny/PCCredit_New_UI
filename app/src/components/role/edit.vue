        ...
        <section class="panel">
          ...
          <div class="panel-body roleParent">
            <div class="form-group row" style="margin-top:30px;">
              ...
              <div class="input-icon right col-sm-10">
                <input v-model="role.roleName" id="roleName" type="text" class="form-control" name="roleName"
                       placeholder="请输入由数字、大小写字母以及下划线组成的3到12位字符">
            ...
            <div class="form-group row" style="margin-top:30px;">
              ...
              <div class="input-icon right col-sm-10">
                <textarea v-model="role.roleDescription" id="roleDescription" type="text" class="form-control"
                          name="roleDescription">${role.roleDescription}</textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 icheck ">
                    <template v-for="auth in group.authorityList">
                      <div class="flat-grey">
                        <div class="radio">
                          <input v-if="auth.selected" checked v-bind:name="group.groupName" type="checkbox"
                                 v-bind:value="auth.id" v-model="auth.selected">
                          <input v-else v-bind:name="group.groupName" type="checkbox" v-bind:value="auth.id"
                                 v-model="auth.selected">
